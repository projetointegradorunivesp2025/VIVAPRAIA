        ...
        <html lang="pt-br">
            ...
            <body> 
                ...
                <nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3; width:300px; padding-bottom:50px;" id="mySidebar">
                    <img src="app/public/logo.png" alt="Avatar" style="width:100%;" onclick="w3_close()"> 
                    <img src="app/public/logo_univesp.jpg" alt="univesp" style="width:100%;" >
                    <br>                    
                    ...
                    <button class='w3-bar-item w3-button link_menu' href='?router=widget' id="widgetmenu"><i class="fas fa-cubes"></i> Widget</button>
                    <button class='w3-bar-item w3-button link_menu' href='?router=login' id="login"><i class="fas fa-sign-in-alt"></i> Login</button>
                </nav>
            ...
            function mySnackbar() 
            {
                ...
                setTimeout(function(){ x.style.display='none'; }, 7000);
            }
