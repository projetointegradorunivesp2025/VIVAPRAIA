...
class Mapa 
{
    ...
    {        
            ...
            for ($i = 0; $i < count($selectDB); $i++) 
            {
                ...
                $locaisFilter[] = "
                    <li class='item w3-bar' onclick='moverMapa({$latitude}, {$longitude})' style='cursor: pointer;'>     
                      <img src='{$bandeira}' class='w3-bar-item w3-circle' >
        ...
        ?>
            ...
            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAETLWKLd1Lp33QaTUoiBqlcJ8xUTGSKWU&loading=async&callback=initMap&v=weekly"></script>
            <script>
                ...
                function initMap() {
                        ...
                        locais.forEach(function(local) {
                                ...
                                var infoWindow = new google.maps.InfoWindow({
                                    content: `<img src='${flatColor}' alt='Ícone'><h3>${local.cidade}</h3>Praia:<h4 style='margin:0px;'>${local.praia}</h4>${local.status}`
                                });
                ...
                function moverMapa(lat, lng) {
                    ...
                    setTimeout(() => marker.setAnimation(null), 10000);            
